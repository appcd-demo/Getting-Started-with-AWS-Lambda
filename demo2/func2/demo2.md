...
add filename `main.zip` 
set function url as `true`

![](./screenshots/step4.png)


### add s3 bucket name same 
...
```
### add `main.zip` to exported IaC folder 
...
aws s3 cp images/ s3://<your-bucket-name>/ --recursive
 ...
 ➜  Demo3 git:(main) ✗ aws s3 cp images s3://sangamdemo/ --recursive
upload: images/3.txt to s3://sangamdemo/3.txt                      
upload: images/2.txt to s3://sangamdemo/2.txt                      
upload: images/5.txt to s3://sangamdemo/5.txt                      
upload: images/4.txt to s3://sangamdemo/4.txt                     
upload: images/1.txt to s3://sangamdemo/1.txt                 
upload: images/6.txt to s3://sangamdemo/6.txt                     
upload: images/5.jpg to s3://sangamdemo/5.jpg                     
upload: images/2.jpg to s3://sangamdemo/2.jpg                     
upload: images/6.jpg to s3://sangamdemo/6.jpg                     
upload: images/1.jpg to s3://sangamdemo/1.jpg                     
upload: images/4.jpg to s3://sangamdemo/4.jpg                     
upload: images/3.jpg to s3://sangamdemo/3.jpg          
